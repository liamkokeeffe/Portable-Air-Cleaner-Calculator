...
export function RoomVentilationInput(props) {
    return (
        <div>
            <p className="helptext">Please rate the ventilation in your room. Refer to the descriptions of each option to determine your ventilation rating. For more information on ventilation visit our resources page here. </p>
